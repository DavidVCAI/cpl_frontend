...
import UserCollectibles from "@/components/collectible/UserCollectibles.tsx";
        ...
        <div className="min-h-screen bg-gray-900 text-white">
                    ...
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="flex items-center space-x-3">
                            <h1 className="text-2xl font-bold">
                                🌆 <span
                                className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-pink-400">CityPulse</span>
                            </h1>
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <div className="bg-gray-800 rounded-lg shadow-xl min-h-[600px]">
                    ...
                    {activeTab === 'collectibles' && (
                        <div className="p-6">
                            <UserCollectibles userId={user.id}/>
                        </div>
                    )}
